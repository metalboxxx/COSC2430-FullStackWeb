...
if (isset($_POST["get_order_detail"])){
        ...
        $_SESSION["selected_order"]["isDelivered"] = $_POST["isDelivered"];
    ...
    <?php
        if (isset($_SESSION['orders'])) {
            foreach ($_SESSION['orders'] as $order) {
                if ($_SESSION["user"]["distribution_hub"] != $order["distribution_hub"] || $order["isDelivered"] == 'true') {
                    continue;
                }
                echo "<tr>";
                echo "<td>{$order["id"]}</td>";
                ...
                echo "<input type='hidden' name='isDelivered' value={$order["isDelivered"]}>";
                echo "</form></td></tr>";
